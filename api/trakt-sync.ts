...
const buildSyncHeaders = (clientId: string, accessToken: string): HeadersInit => ({
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { clientId, accessToken, target, payload } = (req.body ?? {}) as TraktSyncRequestBody
