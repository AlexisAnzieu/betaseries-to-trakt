...
export const MigrationRunner = ({
  ...
  const summary = useMemo(() => {
    const showWatchlist = shows.filter(
    ...
    <section className="panel">
      <header className="panel__header">
        ...
        <p>
          ...
          two payloads to Trakt: one for history and one for your watchlists,
          and display their responses in real time.
        </p>
      </header>
      ...
      <div className="panel__summary">
        <div>
          <strong>Shows</strong>
          <p>
            {summary.showHistory} history · {summary.showWatchlist} watchlist
          </p>
        </div>
        <div>
          <strong>Movies</strong>
          <p>
            {summary.movieHistory} history · {summary.movieWatchlist} watchlist
          </p>
        </div>
      </div>
      ...
      {progress ? (
        <div className="progress">
          ...
          <p className="progress__label">
            ...
            {progress.currentLabel ?? "Fetching identifiers"}
          </p>
        </div>
      ) : null}
